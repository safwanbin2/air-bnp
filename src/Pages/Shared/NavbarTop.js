...
const NavbarTop = () => {
    ...
    return (
        <>
            ...
            <button onClick={handleRefresh} className='hidden md-absolute top-6 left-14 z-20 text-primary text-2xl font-semibold'>airbnp</button>
            <button className='hidden md-absolute top-7 right-14 z-20 '>
